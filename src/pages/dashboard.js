  ...
  return (
    <>
      <div className="AddToCartDiv">
        <span className="pageHeader">Dashboard</span>
            ...
            <div key={i} className="ProdCard">
              ...
              >
                ...
                <div style={{ clear: "both", padding: "0px 5%" }}>
                  ...
                  <span className="ProdDelText">{product.del_Text}</span>
                  <span className="ProdOffPrice">{product.off_price}</span>
                </div>
                <p>
                  <span className="GetIt">Get it by</span>
                  <span className="GetItBy">{product.getIt}</span>
                </p>
              </div>
